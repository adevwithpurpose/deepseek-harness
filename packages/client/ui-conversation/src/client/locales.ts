...
export const zh = {
  ...
  'message.failover.label': '模型切换 {attempt}：{from} → {to}',
  'message.failover.detail': '{fromProvider}/{from} → {toProvider}/{to}',
  'message.routeSelected.label': '路由 {route}：{provider}/{model}',
...
export const en = {
  ...
  'stats.model': 'Model {provider}/{model}',
  'message.model': '{provider}/{model}',
  'stats.llm': 'LLM {duration}',
  ...
  'message.retry.status': '{label} ({retry}/{maximum}) · {seconds}s',
  'message.failover.label': 'Model failover {attempt}: {from} → {to}',
  'message.failover.detail': '{fromProvider}/{from} → {toProvider}/{to}',
  'message.routeSelected.label': 'Route {route}: {provider}/{model}',
