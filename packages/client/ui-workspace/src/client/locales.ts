...
export const zh = {
  ...
  'rename.session.autoName': '自动命名',
  'rename.session.autoNaming': '正在命名…',
  'rename.session.autoUnavailable': '当前部署未挂载自动命名提供方',
...
export const en = {
  ...
  'rename.session.autoName': 'Auto-name',
  'rename.session.autoNaming': 'Naming…',
  'rename.session.autoUnavailable': 'No automatic titler is mounted on this deployment',
