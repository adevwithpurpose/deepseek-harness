...
export class FakeApiClient implements IApiClient {
  ...
  onRetitleAuto: (payload: unknown) => Promise<RpcResponse<{ accepted: boolean; title?: string; seq?: number }>> =
    () => Promise.resolve(ok({ accepted: false }))
  ...
  readonly sessions: IApiClient['sessions'] = {
    ...
    retitleAuto: (payload: unknown) => this.record('session.retitleAuto', payload, this.onRetitleAuto(payload)),
