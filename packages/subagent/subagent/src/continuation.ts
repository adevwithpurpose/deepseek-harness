...
export class SubagentContinuationManager {
  ...
  async startContinuable(spec: ContinuableStartSpec): Promise<ContinuableStart> {
    ...
    const descriptor = snapshotSubagentDescriptor({
      ...
      ...request.agentOptions?.modelRouteMaxTokens !== undefined ? { modelRouteMaxTokens: request.agentOptions.modelRouteMaxTokens } : {},
      ...request.agentOptions?.modelRouteMaxAttempts === undefined ? {} : {
        modelRouteMaxAttempts: request.agentOptions.modelRouteMaxAttempts,
      },
      ...request.agentOptions?.writeScope !== undefined ? { writeScope: request.agentOptions.writeScope } : {},
    ...
    try {
      activation = await this.materialize({
        ...
        agentOptions: {
          ...
          ...descriptor.modelRouteMaxTokens !== undefined ? { modelRouteMaxTokens: descriptor.modelRouteMaxTokens } : {},
          ...descriptor.modelRouteMaxAttempts !== undefined ? { modelRouteMaxAttempts: descriptor.modelRouteMaxAttempts } : {},
          ...descriptor.writeScope !== undefined ? { writeScope: descriptor.writeScope } : {},
        },
